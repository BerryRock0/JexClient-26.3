...
public class BlockButton extends Button {
    ...
    public void render(PoseStack matrixStack) {
        ...
        FontHelper.INSTANCE.drawCenteredString(matrixStack, Component.translatable(block.getTranslationKey()), this.getX() + (this.getWidth() / 2), this.getY() + (this.getHeight() / 2) - 4, isEnabled() ? 0xffaaaaaa : 0xff676767);
