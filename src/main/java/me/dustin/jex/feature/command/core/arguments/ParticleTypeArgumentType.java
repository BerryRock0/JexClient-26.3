...
public class ParticleTypeArgumentType implements ArgumentType<String>
{
    ...
    public String parse(StringReader reader) throws CommandSyntaxException
    {
        ...
        {
            throw new SimpleCommandExceptionType(Component.literal("Not a feature")).createWithContext(reader);
        }
    }
    ...
    {
        Registry.PARTICLE_TYPE.getIds().forEach(identifier -> {builder.suggest(identifier.toString());});
