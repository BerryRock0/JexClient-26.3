...
public class JexEarsFeatureRenderer extends FeatureRenderer<Player, PlayerEntityModel<Player>> {
    public JexEarsFeatureRenderer(FeatureRendererContext<Player, PlayerEntityModel<Player>> featureRendererContext) {
