...
public class SearchFile extends ConfigFile {
    ...
    public void write() {
        ...
        Search.getBlocks().keySet().forEach(block -> {
            ...
            blockData.put("mod", BuiltInRegistries.BLOCK.getId(block).getNamespace());
    ...
    public void read() {
        ...
        parsedYaml.forEach((s, o) -> {
            ...
            Optional<Block> block = BuiltInRegistries.BLOCK.getOrEmpty(new Identifier(mod, s));
    ...
    public void convertJson() {
        ...
        try {
            ...
            for (int i = 0; i < array.size(); i++) {
                ...
                Optional<Block> block = BuiltInRegistries.BLOCK.getOrEmpty(new Identifier(blockID));
